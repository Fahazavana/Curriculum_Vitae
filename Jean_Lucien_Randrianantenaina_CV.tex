...
\begin{itemize}
	\item[\faFlask] \cvResearchEntry{Recomender System on the 25M and 100k MovieLens dataset (Report)}
	      {2024}
	      {Building a movie recommender system using Matrix Factorization with Python/Numpy/Scipy. Exploration of algorithms like ALS, SGD, BPR.}
	...
	\item[\faFlask]\cvResearchEntry{Carmichael Number (Msc. Thesis)}{2023}
	      {Exploring the concept of Carmichael Numbers and proving the non-existence of a Carmichael Number of the forms $2^np+1$, with $p$ prime.}
...
\begin{itemize}
	...
	\item[\faTrophy] Fully Funded D-CLIC 1.0 Programs: SAYNA and the Organisation International  et de la francophonie (OIF).\hfill \textbf{\color{emphasis}2022}
\end{itemize}
\section{Interests}
