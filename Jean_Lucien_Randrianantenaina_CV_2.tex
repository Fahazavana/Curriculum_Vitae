...
\begin{itemize}
	...
	{\textbf{Revelant courses}: Mathematics for Machine Leaning, Foundation of deep Leaning, Computer Vision, Probabilistic Modeling,\\%
	\phantom{\textbf{Revelant courses}:} Natural Language Processing, Reiforcement Learning, Optimization for Machine Learning}
	...
	{\textbf{Revelant courses}: Graph Theory, Artificial Intelligence, Numerical Analysis, Optimization, Distribution and PDEs,\\%
	\phantom{\textbf{Revelant courses}:} Stochastic Simulation, Combinatorics, Algebra}
	...
	{\textbf{Revelant courses}: Statistical Inference, Numerical Analysis with Python, Algebraic Geometry, Cryptography, \\%
	\phantom{\textbf{Revelant courses}:} Quantum information theory}

	\cvEducationEntry{Faculty of Science, University of Fianarantsoa, Madagascar}%
	{Nov. 2015 -- Apr. 2019}%
	{Bsc. in Mathematics and Application -- Fundamental Mathematics \hfill Grade: 14.83/20}
	{\textbf{Revelant courses}: Linear Algebra, Analysis, Algebra, Algorithm, Probability, Statistics, Toplogy}
	...
	% {\textbf{Revelant courses}: Automation, Material resistance, Industrial draw}%   
\end{itemize}
...
\begin{itemize}
	\item[\faFlask]\cvResearchEntry{Optimizing U-net architecture for brain tumour segmentation, using Genetic Algorithm (Msc. Thesis)}%
	      {2023}%
		  {Proposing the usage of genetic algorithm to optimize the hyperparameters of the U-net Architecture.}
...
\end{minipage}\hfill\begin{minipage}[t]{0.28\linewidth}
	...
	\makebox[1.5\lfonts]{}\parbox{\linewidth}{\raggedright
		\cvtag{Numpy} \cvtag{Scipy} \cvtag{Pandas}\cvtag{Scikit-Learn}\cvtag{PyTorch}\cvtag{Tensorflow}\cvtag{Matplotlib} \cvtag{Django}\cvtag{Flask} \cvtag{Bootstrap}\cvtag{NodeJs}}
\end{minipage}\hfill\begin{minipage}[t]{0.28\linewidth}
...
\section{Projects}
\begin{itemize}
	\item[\faCode]\cvProjectEntry{Movie Recomender System}%
	{}%
	{feb. 2024}%
	{Lagre scale recomender system, using probabilistic matrix factorisation and trained on the 25M MovieLens dataset}%
	%%%%%%%%%
...
\section{References}
\begin{itemize}
	\item Prof. Florian Luca, Departments of Mathematics.\\
		Univesity of the Witwatersrand, South Africa, +270 117 176 243, \href{florian.luca@wits.ac.za}{florian.luca@wits.ac.za}
	\item Dr. Aurelle Tchagna Kuanou
	\item Dr. Joelson Randriamparany
	\item Prof. Andreas Buchleitner,\\
	Department for Quantum Optics and Statistics
		Institute of Physics Albert-Ludwigs, Universität of Freiburg \\
